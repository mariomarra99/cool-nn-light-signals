...
<p>Pur provenendo da un’intuizione personale, ho trovato un'implementazione molto efficace proposto proprio dalla <a href="http://https://github.com/jeremyscatigna/Traffic_light_classifier" title="stessa repository">stessa repository</a> del secondo <strong>dataset</strong>.</p>
